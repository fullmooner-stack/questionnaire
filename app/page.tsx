          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 space-y-8 animate-slideInLeft">
              ...
              <p className="max-w-lg text-lg leading-relaxed text-gray-300 animate-fadeIn [animation-delay:0.8s]">
                ...
                explores your lifestyle, preferences, travel dreams, hobbies,
                and more. Your responses will only take a couple of minutes and
                will give you valuable insights into what makes you tick.
              </p>
